...
function LifeDataProvider(props) {
  ...
  useEffectDP(() => { window.LifeStorage.save(state); }, [state]);
  ...
  function deleteTask(id) {
    setStateRaw(prev => {
      ...
      return { ...prev, tasks, activityLog: window.LifeActivity.append(prev.activityLog, log) };
    });
  }
  ...
  function toggleTransactionInclusion(transactionId) {
    setStateRaw(prev => {
      ...
      return { ...prev, transactions, activityLog: window.LifeActivity.append(prev.activityLog, log) };
    });
  }
