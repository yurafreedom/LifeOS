...
const LIFE_STRINGS = {
  ru: {
    ...
    goal_tag_q4:        'Q4',
    goal_tag_jan:       'янв',
    goal_add_placeholder: 'новая цель…',
    ...
    fin_filter_all:      'все',
    fin_filter_visible:  'учтено',
    fin_filter_hidden:   'не учтено',
    ...
    auth_login_eyebrow: 'защищённый вход',
    auth_login_title: 'войти в Life·OS',
    auth_login_copy: 'Данные этого аккаунта хранятся на вашем сервере.',
    auth_setup_eyebrow: 'первичная настройка',
    auth_setup_title: 'создать первый аккаунт',
    auth_setup_copy: 'Этот экран работает один раз. Вставьте bootstrap token с сервера вручную.',
    auth_email: 'почта',
    auth_password: 'пароль',
    auth_password_confirm: 'повторите пароль',
    auth_bootstrap_token: 'bootstrap token',
    auth_password_mismatch: 'пароли не совпадают',
    auth_password_length: 'пароль должен содержать не менее 12 символов',
    auth_invalid_credentials: 'не удалось войти: проверьте почту и пароль',
    auth_bootstrap_invalid: 'неверный setup token',
    auth_bootstrap_closed: 'первый аккаунт уже создан; используйте вход',
    auth_validation_error: 'проверьте заполненные поля',
    auth_network_error: 'сервер недоступен; проверьте подключение',
    auth_working: 'подождите…',
    auth_create: 'создать аккаунт',
    auth_login: 'войти',
    auth_to_login: 'перейти ко входу',
    auth_logout: 'выйти',
    auth_logout_error: 'локальные данные скрыты, но сервер не подтвердил выход',
    boot_loading: 'Life·OS — загрузка…',
    boot_server_title: 'сервер недоступен',
    boot_server_copy: 'не удалось проверить сессию',
    boot_state_title: 'данные недоступны',
    boot_state_copy: 'не удалось загрузить снимок аккаунта',
    boot_retry: 'повторить',
    boot_export_raw: 'выгрузить ответ сервера',
    import_eyebrow: 'локальный снимок найден',
    import_title: 'импортировать прежние данные?',
    import_copy: 'Выберите явно: скопировать локальные данные на сервер или начать с чистого состояния.',
    import_invalid_title: 'локальный снимок повреждён',
    import_invalid_copy: 'Автоматический импорт остановлен. Можно скачать исходник или начать заново.',
    import_version: 'версия',
    import_size: 'размер',
    import_tasks: 'задачи',
    import_goals: 'цели',
    import_transactions: 'транзакции',
    import_medications: 'препараты',
    import_notes: 'заметки',
    import_activity: 'события',
    import_use_local: 'импортировать локальные данные',
    import_start_fresh: 'начать заново',
    import_download_raw: 'скачать исходный JSON',
    sync_status: 'синхронизация',
    sync_saved: 'сохранено на сервере',
    sync_saving: 'сохранение…',
    sync_offline: 'нет связи · изменения не сохранены',
    sync_conflict: 'конфликт версий · запись остановлена',
    sync_error: 'ошибка сохранения',
    sync_retry: 'повторить',
    sync_export_unsaved: 'выгрузить несохранённое',
    sync_reload_server: 'загрузить серверную версию',
    sync_reload_confirm: 'Несохранённые изменения будут отброшены. Загрузить серверную версию?',
    ...
    set_scene_auto:   'АВТО',
    set_scene_day:    'ДЕНЬ',
    set_scene_night:  'НОЧЬ',
    set_scene_paradise_only: 'только для острова',
    ...
    set_export_server_hint:'текущий снимок аккаунта с сервера',
    set_export_account: 'полный экспорт аккаунта',
    set_export_account_hint: 'ZIP · текущий снимок и вся семантическая история',
    set_export_account_download: 'скачать ZIP',
    set_export_account_loading: 'подготовка…',
    set_export_account_error: 'Не удалось выгрузить аккаунт. Проверьте подключение и вход, затем повторите.',
    set_reset_confirm:    'да, создать чистое состояние',
    set_reset_done:       'чистое состояние сохранено на сервере',
    set_reset_failed:     'сброс не подтверждён сервером; данные сохранены',
  ...
  uk: {
    ...
    goal_tag_q4:        'Q4',
    goal_tag_jan:       'січ',
    goal_add_placeholder: 'нова ціль…',
    ...
    fin_total_in:        'враховано',
    fin_total_hidden:    'не враховано',
    ...
    fin_filter_all:      'усі',
    fin_filter_visible:  'враховано',
    fin_filter_hidden:   'не враховано',
    ...
    footer_local:    'локально',
    auth_login_eyebrow: 'захищений вхід',
    auth_login_title: 'увійти до Life·OS',
    auth_login_copy: 'Дані цього акаунта зберігаються на вашому сервері.',
    auth_setup_eyebrow: 'первинне налаштування',
    auth_setup_title: 'створити перший акаунт',
    auth_setup_copy: 'Цей екран працює один раз. Вставте bootstrap token із сервера вручну.',
    auth_email: 'пошта',
    auth_password: 'пароль',
    auth_password_confirm: 'повторіть пароль',
    auth_bootstrap_token: 'bootstrap token',
    auth_password_mismatch: 'паролі не збігаються',
    auth_password_length: 'пароль має містити щонайменше 12 символів',
    auth_invalid_credentials: 'не вдалося увійти: перевірте пошту й пароль',
    auth_bootstrap_invalid: 'неправильний setup token',
    auth_bootstrap_closed: 'перший акаунт уже створено; скористайтеся входом',
    auth_validation_error: 'перевірте заповнені поля',
    auth_network_error: 'сервер недоступний; перевірте з’єднання',
    auth_working: 'зачекайте…',
    auth_create: 'створити акаунт',
    auth_login: 'увійти',
    auth_to_login: 'перейти до входу',
    auth_logout: 'вийти',
    auth_logout_error: 'локальні дані приховано, але сервер не підтвердив вихід',
    boot_loading: 'Life·OS — завантаження…',
    boot_server_title: 'сервер недоступний',
    boot_server_copy: 'не вдалося перевірити сесію',
    boot_state_title: 'дані недоступні',
    boot_state_copy: 'не вдалося завантажити знімок акаунта',
    boot_retry: 'повторити',
    boot_export_raw: 'вивантажити відповідь сервера',
    import_eyebrow: 'знайдено локальний знімок',
    import_title: 'імпортувати попередні дані?',
    import_copy: 'Оберіть явно: скопіювати локальні дані на сервер або почати з чистого стану.',
    import_invalid_title: 'локальний знімок пошкоджено',
    import_invalid_copy: 'Автоматичний імпорт зупинено. Можна завантажити оригінал або почати заново.',
    import_version: 'версія',
    import_size: 'розмір',
    import_tasks: 'задачі',
    import_goals: 'цілі',
    import_transactions: 'транзакції',
    import_medications: 'препарати',
    import_notes: 'нотатки',
    import_activity: 'події',
    import_use_local: 'імпортувати локальні дані',
    import_start_fresh: 'почати заново',
    import_download_raw: 'завантажити вихідний JSON',
    sync_status: 'синхронізація',
    sync_saved: 'збережено на сервері',
    sync_saving: 'збереження…',
    sync_offline: 'немає зв’язку · зміни не збережено',
    sync_conflict: 'конфлікт версій · запис зупинено',
    sync_error: 'помилка збереження',
    sync_retry: 'повторити',
    sync_export_unsaved: 'вивантажити незбережене',
    sync_reload_server: 'завантажити серверну версію',
    sync_reload_confirm: 'Незбережені зміни буде відкинуто. Завантажити серверну версію?',
    ...
    set_scene_day:    'ДЕНЬ',
    set_scene_night:  'НІЧ',
    set_scene_paradise_only: 'лише для острова',
    ...
    set_export_server_hint:'поточний знімок акаунта із сервера',
    set_export_account: 'повний експорт акаунта',
    set_export_account_hint: 'ZIP · поточний знімок і вся семантична історія',
    set_export_account_download: 'завантажити ZIP',
    set_export_account_loading: 'підготовка…',
    set_export_account_error: 'Не вдалося вивантажити акаунт. Перевірте з’єднання і вхід, потім повторіть.',
    set_reset_confirm:    'так, створити чистий стан',
    set_reset_done:       'чистий стан збережено на сервері',
    set_reset_failed:     'скидання не підтверджено сервером; дані збережено',
...
const LifeMakeT = makeT;
const LifeLocaleContext = React.createContext({ locale: 'ru', t: makeT('ru'), setLocale: () => {} });
