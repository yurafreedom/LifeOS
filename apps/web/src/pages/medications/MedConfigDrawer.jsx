...
import { MultiChangeWarningModal } from '../../components/MultiChangeWarningModal.jsx';
...
function MedConfigDrawer({ med, onClose }) {
  const data   = useCtxCD(LifeDataContext);
  const { t, locale } = useCtxCD(LifeLocaleContext);
  const I = LIcons;
