...
import { FoodPreferencesCard } from '../profile/cards/FoodPreferencesCard.jsx';
import { IdentityCard } from '../profile/cards/IdentityCard.jsx';
import { MeasurementsCard } from '../profile/cards/MeasurementsCard.jsx';
...
function ProfilePage({ profile, onUpdate }) {
  const { t } = useCtxPP(LifeLocaleContext);

  const CARDS = [
    { id: 'identity',     comp: IdentityCard,         slice: 'identity'     },
    { id: 'body',         comp: BodyMetricsCard,      slice: 'body'         },
    { id: 'measurements', comp: MeasurementsCard,     slice: 'measurements' },
    { id: 'sizes',        comp: ClothingSizesCard,    slice: 'sizes'        },
    { id: 'food',         comp: FoodPreferencesCard,  slice: 'food'         },
  ];
